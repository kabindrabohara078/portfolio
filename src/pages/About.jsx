...
const About = () => {
  return (
    <div className="about-main">
      <h1 className='name name-up'>KABINDRA BOHARA G</h1>

      <div className="profile-image">
        <div className='pic'>
          <img src="/profile-picture.jpeg" alt="Kabindra Bohara G Profile" />
        </div>

        <div className='opl'>
          <div className="page-quick">
            <a href="https://one-page-resume-ashen.vercel.app/" target="_blank" rel="noopener noreferrer">
      ...
      <h1 className='name-down'>KABINDRA BOHARA G</h1>
      ...
      <div className="keywords">
        ...
        <ul>
          <li><span>1.</span> Design Thinker</li>
          <li><span>2.</span> Team Leader</li>
          <li><span>3.</span> Optimistic Thinker</li>
        </ul>
      </div>
    </div>
  )
